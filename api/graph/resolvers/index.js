...
exports.getImage = (id) => get(`http://localhost:4001/profilePictures/${id}`);
exports.getImages = () => get(`http://localhost:4001/profilePictures`);

exports.getUserPosts = (id) => get(`http://localhost:4001/users/${id}/posts`);
exports.getUserProfilePictures = (id) =>
  get(`http://localhost:4001/users/${id}/profilePictures`);
